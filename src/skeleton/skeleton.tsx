...
import { TdSkeletonProps, SkeletonRowCol, SkeletonRowColObj } from './type'
import { StyledProps, Styles, TNode } from '../common'
import { pxCompat } from '../common/helper'
...
@tag('t-skeleton')
export default class Skeleton extends WeElement<SkeletonProps> {
  ...
  render(props: OmiProps<SkeletonProps, any>, store: any) {
    const { animation, loading, rowCol, theme, class: className, style, delay = 0, children } = props
    const classPrefix = 't'
